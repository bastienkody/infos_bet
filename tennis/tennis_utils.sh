...
[[ $(echo $code_m) != 200 ]] && echo "Erreur requete ranking tennis men, code : $code_m" && exit 10
...
[[ $(echo $code_w) != 200 ]] && echo "Erreur requete ranking tennis women, code : $code_w" && exit 10
